...
exports.authorized = exports.isAuthenticated = void 0;
...
const authorized = (...roles) => {
    return (req, res, next) => {
        ...
        if (!roles.includes(((_a = req.user) === null || _a === void 0 ? void 0 : _a.role) || '')) {
            return next(new error_handler_1.default(`Role: ${(_b = req.user) === null || _b === void 0 ? void 0 : _b.role} is not allowed to access this resourse`, 403));
        }
        next();
    };
};
